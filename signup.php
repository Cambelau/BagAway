...
$requete = "INSERT INTO `user` (`id`, `name`, `phone`,`email`, `password`) VALUES (NULL,'$name','$phonenbr','$email','$password')";
try
{
$conn->query($requete);
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            <div class="text-center">
              <h1 class="font-semibold text-white text-4xl">Bagaway - Signup</h1>
            </div>
          </div>
        </div>
      </div>
